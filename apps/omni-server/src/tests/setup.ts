...
beforeAll(async () => {
  ...
  process.env.OMNI_DATABASE_URL = process.env.TEST_OMNI_DATABASE_URL || 'postgresql://test:test@localhost:5432/omni_test'
  process.env.SHARED_DATABASE_URL = process.env.TEST_SHARED_DATABASE_URL || 'postgresql://test:test@localhost:5432/omni_shared_test'
