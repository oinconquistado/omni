...
export function useApiMutation<TData = unknown, TError = ApiError, TVariables = unknown>(
  ...
  const enhancedOnMutate = useCallback(
  ...
  const enhancedOnSuccess = useCallback(
    (data: ApiResponse<TData>, variables: TVariables, context: any) => {
  ...
  const enhancedOnSettled = useCallback(
    (data: ApiResponse<TData> | undefined, error: TError | null, variables: TVariables, context: any) => {
